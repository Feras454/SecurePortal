...
function validateForm() {
  let x = document.forms["resett"]["new_password"].value;
  let y = document.forms["resett"]["confirm_password"].value;
...
<body>
    <div class="textbox">
        ...
        <form name="resett" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" onsubmit="return validateForm()"> 
            <div>
            ...
            <div>
                ...
                <a class="button5" href="welcome.php">Cancel</a>
            </div>
        </form>
    </div>    
</body>
