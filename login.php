...
function validateForm() {
  let x = document.forms["loginn"]["username"].value;
  let y = document.forms["loginn"]["password"].value;
...
<body>
    <div class="textbox">
        ...
        <form name="loginn" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" onsubmit="return validateForm()">
